...
command.send = function(id, data) {
    var SSH = new SSH2Shell({
        server: this.server,
        commands: ["hadoop jar /home/bigdata04/taller1/RF3_2.jar uniandes.job.Job3 datos/taxis_subsample output/taller1/RF3_" + id + " 2 10 14 20"]
...
command.read = function(id, callback) {
    var SSH = new SSH2Shell({
        server: this.server,
        commands: ["hadoop fs -cat output/taller1/RF3_" + id + "_ordenados/part-r-00000"]
